...
data = pd.read_csv('../../../Downloads/backend/data/user_transactions.csv')

# Define features and target variable
X = data[['loan', 'income', 'expenses', 'necessary_expenses', 'unnecessary_expenses']]
y = data['loan_payment']
...
param_grid = {
    ...
    'max_depth': [None, 1, 2],  # Maximum depth of the trees
    'min_samples_split': [2, 5, 0.1],  # Minimum number of samples required to split an internal node
...
# Save the best model
joblib.dump(best_model, '../../../Downloads/backend/model/multiple_trained_model.pkl')
